...
namespace alg1wpf.logical
{
    public class Graph
    {
        ...
        public List<int> FirstExperimentForDijkstraDHeap()
        {
        ...
        public List<int> FirstExperimentForFordBellman()
        {
            List<int> timeWork = new List<int>();
            graph = new Node[countNode];
            result = new Result(countNode);
        ...
        public List<int> SecondExperimentForDijkstraDHeap()
        {
            List<int> timeWork = new List<int>();
            graph = new Node[countNode];
            heap = new HeapD(sizeHeap, countNode);
        ...
        public List<int> SecondExperimentForFordBellman()
        {
            List<int> timeWork = new List<int>();
            graph = new Node[countNode];
            result = new Result(countNode);
